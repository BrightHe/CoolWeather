package com.example.hzh.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        manager.cancel( pi );
        manager.set( AlarmManager.ELAPSED_REALTIME_WAKEUP,targetTime,pi );
    ...
    private void updateWeather() {
        ...
        if (weatherString != null){
            //有缓存时直接解析天气数据
            final HeWeather weather = Utility.handleWeatherResponse( weatherString );
